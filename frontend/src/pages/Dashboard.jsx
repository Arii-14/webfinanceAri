...
import { LayoutDashboard, ReceiptText, Users, LogOut, Plus, Trash2, Settings, Target, Wallet, CalendarClock, Download, AlertTriangle, BookHeart, KeyRound, Menu, X, Camera, Pencil, Landmark, Tags, HandCoins } from 'lucide-react';
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
        ...
        <div className="header">
          ...
          <div className="header-actions user-profile">
            ...
            <div
              ...
              title="Klik untuk unggah foto profil"
              role="button"
              tabIndex={0}
